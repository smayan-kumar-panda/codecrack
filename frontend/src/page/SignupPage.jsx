        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-4xl font-bold mt-2 text-lime-600 hover:text-primary">Welcome to CodeCrack</h1>
              <p className="text-lime-600 hover:text-primary from-stone-400 font-medium">Create your account</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium text-lime-600">Name</span>
              </label>
          ...
          <div className="text-center">
            <p className="text-base-content/60">
              ...
              <Link to="/login" className="link link-primary text-lime-500">
                Log in
              </Link>
            </p>
          </div>
